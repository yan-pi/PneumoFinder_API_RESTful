...
def main():
    ...
    print(f"⚖️  Best Trade-off: {best_tradeoff['model']} ({best_tradeoff['words_per_second']:.1f} words/s)")
    ...
    for r in successful_results:
        ...
        medical_terms = ["consolidação", "infiltrado", "opacidade", "broncograma", 
                        "campo pulmonar", "radiografia", "tórax", "bilateral"]
