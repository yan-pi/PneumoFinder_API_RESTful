...
class LLaVaMedInference:
    ...
    def __init__(self, model_path: str = "microsoft/llava-med-v1.5-mistral-7b"):
        ...
        self.tokenizer, self.model, self.image_processor, self.context_len = load_pretrained_model(
            model_path=model_path, model_base=None, model_name=self.model_name, device_map="auto"
        )
        print("✓ Model loaded")
    ...
    def analyze_image(self, image_path: str, prompt: str) -> str:
        ...
        # Tokenize
        input_ids = self.tokenizer([prompt_formatted]).input_ids.to(self.model.device)
